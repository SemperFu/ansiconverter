...
namespace MediaFormats
{
    public class Avi
    {
        ...
        [DllImport("avifil32.dll")]
        public static extern int AVIFileCreateStream(int pfile, ref IntPtr ppavi, ref AVISTREAMINFOstruc ptr_streaminfo);

        //Set the format for a new stream
        [DllImport("avifil32.dll")]
        public static extern int AVIStreamSetFormat(IntPtr aviStream, Int32 lPos, ref BITMAPINFOHEADERstruc lpFormat, Int32 cbFormat);
