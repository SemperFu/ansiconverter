...
namespace ConverterSupport
{
    public class InputOutput
    {
            ...
            if (File.Exists(OutFileName))
            {
                ...
                else
                {
                    switch (iOutExists)
                    {
                        ...
                        case 3:
                            //Ask
                            if (MsgBox("Output File: " + OutFileName + " already exists.\r\n" + "Do you want to overwrite it?",MsgBoxStyle.YesNo, "File Exists") == MsgBoxResult.Yes)
                            {
                                File.Delete(OutFileName);
                                bProceed = true;
                                aResult[0] = "4";
                        ...
                        if (sStr is Bitmap)
                        {
                            ...
                            if (bCreateThumbs == true)
                            {
                                switch (iThumbsResOpt)
                                {
                                    case 0:
                                        //Scale Percent
                                        iThWidth = (int)((img.Width / 100) * iThumbsScale);
                                        iThHeight = (int)((img.Height / 100) * iThumbsScale);
                                        break;

                                    case 1:
                                        iThWidth = iThumbsWidth;
                                        iSFact = iThWidth / img.Width;
                                        iThHeight = (int)(img.Height * iSFact);
                                        break;

                                    case 2:
                                        iThHeight = iThumbsHeight;
                                        iSFact = iThHeight / img.Height;
                                        iThWidth = (int)(img.Width * iSFact);
                                        break;
        ...
        public static string[] OutputASCHTML(string sOutFile, string sASC)
        {
            ...
            {
                bteWork1[iLp2 - 1] = (byte)Asc(Mid(sOut, iLp2, 1));
        ...
        public static string BuildCSSforHTML()
        {
            ...
            else
            {
                ...
                {
                    sWorkCSS = Strings.Replace(sWorkCSS, "%EXTRACSSDIV%", ((WebFontDef)(WebFontList[Data.SelectedWebFont])).AnimEXTRACSSDIV, 1, -1, CompareMethod.Text);
                    sWorkCSS = Strings.Replace(sWorkCSS, "%EXTRACSSPRE%", ((WebFontDef)(WebFontList[Data.SelectedWebFont])).AnimEXTRACSSPRE, 1, -1, CompareMethod.Text);
                    sWorkCSS = Strings.Replace(sWorkCSS, "%EXTRACSSSPAN%", ((WebFontDef)(WebFontList[Data.SelectedWebFont])).AnimEXTRACSSSPAN, 1, -1, CompareMethod.Text);
                }
                else
                {
                    sWorkCSS = Strings.Replace(sWorkCSS, "%EXTRACSSDIV%", ((WebFontDef)(WebFontList[Data.SelectedWebFont])).StaticEXTRACSSDIV, 1, -1, CompareMethod.Text);
                    sWorkCSS = Strings.Replace(sWorkCSS, "%EXTRACSSPRE%", ((WebFontDef)(WebFontList[Data.SelectedWebFont])).StaticEXTRACSSPRE, 1, -1, CompareMethod.Text);
                    sWorkCSS = Strings.Replace(sWorkCSS, "%EXTRACSSSPAN%", ((WebFontDef)(WebFontList[Data.SelectedWebFont])).StaticEXTRACSSSPAN, 1, -1, CompareMethod.Text);
                }
                ...
                for (x = Data.minX; x <= Data.maxX; x++)
                {
                    ...
                    if (iWhatChange != 0)
                    {
                        ...
                        if (iWhatChange > 9)
                        {
                            ...
                            aOut[Cnt] = 59;
                            Cnt += 1;
                            aOut[Cnt] = (byte)Asc(Strings.Left(InternalConstants.AnsiForeColors[Data.ForeColor], 1));
                            Cnt += 1;
                            aOut[Cnt] = (byte)Asc(Strings.Right(InternalConstants.AnsiForeColors[Data.ForeColor], 1));
                            Cnt += 1;
                            aOut[Cnt] = 59;
                            Cnt += 1;
                            aOut[Cnt] = (byte)Asc(Strings.Left(InternalConstants.AnsiBackColors[Data.BackColor], 1));
                            Cnt += 1;
                            aOut[Cnt] = (byte)Strings.Asc(Strings.Right(InternalConstants.AnsiBackColors[Data.BackColor], 1));
                            Cnt += 1;
                            aOut[Cnt] = 109;
                            Cnt += 1;
                        }
                        else
                        {
                            ...
                            if (iWhatChange == 8)
                            {
                                ...
                                aOut[Cnt] = 91;
                                Cnt += 1;
                                aOut[Cnt] = (byte)Strings.Asc(Strings.Left(InternalConstants.AnsiBackColors[BackColor], 1));
                                Cnt += 1;
                                aOut[Cnt] = (byte)Strings.Asc(Strings.Right(InternalConstants.AnsiBackColors[BackColor], 1));
                                Cnt += 1;
                                aOut[Cnt] = 109;
                                Cnt += 1;
                            }
                            else
                            {
                                ...
                                aOut[Cnt] = 59;
                                Cnt += 1;
                                aOut[Cnt] = (byte)Strings.Asc(Strings.Left(InternalConstants.AnsiForeColors[Data.ForeColor], 1));
                                Cnt += 1;
                                aOut[Cnt] = (byte)Strings.Asc(Strings.Right(InternalConstants.AnsiForeColors[Data.ForeColor], 1));
                                Cnt += 1;
                                aOut[Cnt] = 109;
                                Cnt += 1;
                            }
                    ...
                    if (Data.Screen[x, y].Chr != Strings.Chr(0).ToString())
                    {
                        if (Data.Screen[x, y].Chr == Strings.Chr(32).ToString())
                        {
                            ...
                            if (iSpc > Data.maxX)
                            {
                                ...
                                {
                                    aOut[Cnt] = (byte)Asc(Strings.Mid(iSpc.ToString(), iLoop2, 1));
                                    Cnt += 1;
                                }
                                aOut[Cnt] = 67;
                                Cnt += 1;
                            ...
                            {
                                aOut[Cnt] = (byte)Asc(Data.Screen[x, y].Chr);
                                Cnt += 1;
                            }
                        }
                        else
