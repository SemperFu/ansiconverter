...
namespace ConverterSupport
{
    ...
    public class Convert
    {
        ...
        /// <remarks></remarks>
        private SauceMeta ReadSauce(byte[] aAnsi, int Offset)
        {
            //Read SAUCE Meta Tag Content from Byte Array to Special Sauce Meta Class
            SauceMeta oSauce;
            int iLoop = Offset;
        ...
        private string ReadByteArray(ref byte[] Arr, int iLen, string DtaType)
        {
            int a;
            string sRes = "";
            if (DtaType == "b")
        ...
        /// <remarks></remarks>
        public static int ChkNum(object iVal)
        {
        ...
        /// <returns>Byte Array</returns>
        /// <remarks></remarks>
        public static byte[] StringToByteArray(string sStr)
        {
            byte[] bte = new byte[] { 0 };
            if (sStr.Length > 0)
            {
        ...
        /// <remarks></remarks>
        public static byte[] NullByteArray()
        {
            byte[] aByte = { 0 };
            return aByte;
        }
        ...
        /// <remarks>Note: Bit Location is 1 based and not 0</remarks>
        public static void SetBit(ref byte MyByte, byte MyBit)
        {
            Int16 BitMask;
            MyByte = System.Convert.ToByte(MyByte & 0xff);
            BitMask = System.Convert.ToInt16(Math.Pow(2, (MyBit - 1)));
        ...
        public static System.Drawing.Bitmap ByteArrayToBitmap(byte[] Bte, int TextWidth, int NumLines, bool bSmallFnt = false)
        {
            byte FntCurrChar = 0;
            int iMaxWidth = 0;
            int iMaxHeight = 0;
        ...
        /// <returns>Bitmap Frame in Format <see cref="System.Windows.Media.PixelFormat"/> = 'Indexed8'</returns>
        /// <remarks></remarks>
        public static System.Drawing.Bitmap CreateVideoFrame(bool bSmallFnt = false, bool nocolors = false, int YIndex = 0)
        {
            byte FntCurrChar = 0;
            int iMaxWidth = 0;
            int iMaxHeight = 0;
        ...
        /// <remarks></remarks>
        public static System.Drawing.Bitmap BitmapToIndexed(System.Drawing.Bitmap bm, System.Drawing.Imaging.ColorPalette pal)
        {
        ...
        public static byte FindPalettenEntry(System.Drawing.Color col, System.Drawing.Imaging.ColorPalette cp, bool bIgnoreAlpha = true)
        {
            byte iResult = 0;
            bool bFound = false;
        ...
        /// <remarks></remarks>
        public static bool TestColorCloser(System.Drawing.Color Color1, System.Drawing.Color CurrNearCol, System.Drawing.Color CompColor)
        {
            double MinDist;
            double DistCI;
        ...
        /// <remarks></remarks>
        public static System.Drawing.Color GetClosestExistingRGBColor(System.Drawing.Color ColorI, System.Drawing.Imaging.ColorPalette pal)
        {
